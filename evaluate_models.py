...
models = np.append(models,Model(ions,patt,model_mid,0.01,0.01,l,u,model_width))#k))
...
models = np.append(models,Model(ions,patt,model_mid,10.,1.,l,u,model_width))#k))
patt = "/u/10/l/lnc2115/vega/repos/CGMemission/bertone_frbs/coldens/grid_galquas/g10q10/frb"
models = np.append(models,Model(ions,patt,model_mid,10.,10.,l,u,k))
