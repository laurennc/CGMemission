...
def make_thin_frb(pf,axis,fields,center,width,thickness,resolution,weight_field=None):
        axis = fix_axis(axis)
...
if coldens:	
	...
	file_begin = 'bertone_frbs/coldens/grid_galquas/z075/g1q10/'
...
if emission:
	...
	file_begin = 'bertone_frbs/final/emis/z075/g1q10/'	
	fields = ['Emission_OVI','Emission_CIII_977','Emission_CIV','Emission_SiIV']
	#file_begin = 'frb_resolution_z075_1kpc_zscaled_Zfixed_500kpc_'
...
if project_X:
	...
	for field in fields:
                ...
                fileout = file_begin + 'frbx_1kpc_500kpc_z075_'+key+file_end
...
if project_Y:
	...
	for field in fields:
                key = re.split(key_string,field)[keydx]
                fileout = file_begin + 'frby_1kpc_500kpc_z075_'+key+file_end
...
if project_Z:
	axis = 'z'
        ...
        for field in fields:
                key = re.split(key_string,field)[keydx]
                fileout = file_begin + 'frbz_1kpc_500kpc_z075_'+key+file_end
