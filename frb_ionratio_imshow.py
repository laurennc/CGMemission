...
plt.colorbar()
plt.savefig('SiIV_CIII.png')
plt.close()

plt.imshow(np.log10(frb_CIII/frb_CIV),extent=(-160,160,160,-160),interpolation='none',cmap=cmap,origin='lower')
plt.colorbar()
plt.savefig('CIII_CIV.png')
plt.close()

plt.imshow(np.log10(frb_CIII/frb_OVI),extent=(-160,160,160,-160),interpolation='none',cmap=cmap,origin='lower')
plt.colorbar()
plt.savefig('CIII_OVI.png')
plt.close()
